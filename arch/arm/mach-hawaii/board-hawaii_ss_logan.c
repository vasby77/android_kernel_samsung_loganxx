...
static struct i2c_board_info  __initdata micro_usb_i2c_devices_info[]  = {
        {
#if defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV03)
...
static void __init hawaii_add_i2c_devices(void)
{
	...
	rt8973_wakelock_init();
       i2c_register_board_info(RT_I2C_BUS_ID, micro_usb_i2c_devices_info,ARRAY_SIZE(micro_usb_i2c_devices_info));
#endif
...
MACHINE_START(HAWAII, "hawaii_ss_logan")
	.atag_offset = 0x100,

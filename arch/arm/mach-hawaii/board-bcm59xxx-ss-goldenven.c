...
/* mask 0x00 is invalid value for mask */
	...
	/*  enable PC3 function */
	{.addr = PMU_REG_GPIOCTRL2, .val = 0x06, .mask = 0xFF},
	/* Selecting 0.87V */
...
/* TODO regulator */
	...
	{.addr = PMU_REG_GPLDO2CTRL, .val = 0xB8, .mask = 0xFF},
...
struct bcmpmu59xxx_regulator_init_data
	bcm59xxx_regulators[BCMPMU_REGULATOR_MAX] = {
		...
		[BCMPMU_REGULATOR_CAMLDO2] = {
			...
			.dsm_mode = BCMPMU_REGL_OFF_IN_DSM,
			.pc_pins_map =
				PCPIN_MAP_ENC(0, PMU_PC2|PMU_PC3),
			.name = "cam2",
			.req_volt = 0,
		},
...
static struct batt_esr_temp_lut ss_eb425161_esr_temp_lut[] = {
	{
		...
		.esr_vl_lvl= 3831 ,.esr_vl_slope= -5697 ,.esr_vl_offset= 23742,
		.esr_vm_lvl= 4113 ,.esr_vm_slope= 671 ,.esr_vm_offset= -656,
		.esr_vh_lvl= 4271 ,.esr_vh_slope= 1547 ,.esr_vh_offset= -4259,
		.esr_vf_slope= -8752 ,.esr_vf_offset= 39727,
	},
	{
		.temp = -150,
		.reset=0,.fct =  452 , .guardband = 50,
		.esr_vl_lvl= 3698 ,.esr_vl_slope= -67595 ,.esr_vl_offset= 251763,
		.esr_vm_lvl= 3861 ,.esr_vm_slope= -3545 ,.esr_vm_offset= 14906,
		.esr_vh_lvl= 4163 ,.esr_vh_slope= 920 ,.esr_vh_offset= -2333,
		.esr_vf_slope= -2503 ,.esr_vf_offset= 11917,
	},
	{
		.temp = -100,
	...
	},
	{
		...
		.esr_vl_lvl= 3692 ,.esr_vl_slope= -9561 ,.esr_vl_offset= 36905,
		.esr_vm_lvl= 3811 ,.esr_vm_slope= -7588 ,.esr_vm_offset= 29622,
		.esr_vh_lvl= 4073 ,.esr_vh_slope= 651 ,.esr_vh_offset= -1780,
		.esr_vf_slope= -1176 ,.esr_vf_offset= 5661,
	},
	{
		.temp = 0,
	...
	},
	{
		...
		.esr_vl_lvl= 3690 ,.esr_vl_slope= -5235 ,.esr_vl_offset= 20299,
		.esr_vm_lvl= 3698 ,.esr_vm_slope= -46051 ,.esr_vm_offset= 170898,
		.esr_vh_lvl= 4334 ,.esr_vh_slope= -441 ,.esr_vh_offset= 2232,
		.esr_vf_slope= -1493 ,.esr_vf_offset= 6792,
	},
	{
		.temp = 100,
	...
	},
	{
		...
		.esr_vl_lvl= 3687 ,.esr_vl_slope= -1709 ,.esr_vl_offset= 6697,
		.esr_vm_lvl= 3698 ,.esr_vm_slope= -12178 ,.esr_vm_offset= 45294,
		.esr_vh_lvl= 3974 ,.esr_vh_slope= 150 ,.esr_vh_offset= -295,
		.esr_vf_slope= -299 ,.esr_vf_offset= 1489,
	},
	{
		.temp = 200,

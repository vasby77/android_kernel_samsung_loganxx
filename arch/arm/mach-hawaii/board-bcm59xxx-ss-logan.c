...
#if defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) || defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV03)
...
static struct regulator_init_data bcm59xxx_audldo_data = {
	.constraints = {
			...
			.always_on = 1, // should be 1 with set_mode
			},
...
static struct bcmpmu_fg_pdata fg_pdata = {
	...
	.fg_factor = 989, /* Logan00 board : 2.76% err Jan30 2010 */

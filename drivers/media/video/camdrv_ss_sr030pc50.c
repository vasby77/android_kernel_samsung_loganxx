...
#if defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV01)||defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV02)|| defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV03) || defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV00) || defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) 
...
static int camdrv_ss_sr030pc50_sensor_power(int on)
{
	...
	#if 1// defined(CONFIG_MACH_HAWAII_SS_GOLDENVEN)\
        //         || defined(CONFIG_MACH_HAWAII_SS_CODINAN)

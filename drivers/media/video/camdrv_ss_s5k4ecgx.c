...
static struct regulator *VCAM1_IO_1_8_V;
...
#if defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV02)|| defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV03) || defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV00)|| defined(CONFIG_MACH_HAWAII_SS_LOGANDS_REV01) 
...
#define VCAM1_IO_1_8V_REGULATOR_uV	1786000
...
int camdrv_ss_s5k4ecgx_set_preview_start(struct v4l2_subdev *sd)
{
	...
	{
		/* DCJO: temporary added fixed FPS for 720p performance test */
...
static int camdrv_ss_s5k4ecgx_sensor_power(int on)
{
	...
	if(IS_ERR(VCAM_A_2_8_V))
	{
		...
		return -1;
	     ...
	     VCAM1_IO_1_8_V = regulator_get(NULL, VCAM1_IO_1_8V_REGULATOR);
	if(IS_ERR(VCAM1_IO_1_8_V))
	{
		CAM_ERROR_PRINTK("can not get VCAM1_IO_1.8V\n");
		return -1;
	}
...
//		iowrite32(value, padctl_base + PADCTRLREG_DCLK1_OFFSET);
	...
	if(on)
	{
		...
		if (value)
			...
			value = regulator_set_voltage(VCAM1_IO_1_8_V, VCAM1_IO_1_8V_REGULATOR_uV, VCAM1_IO_1_8V_REGULATOR_uV);
		if (value)
			CAM_ERROR_PRINTK("%s:regulator_set_voltage VCAM1_IO_1_8_V failed \n", __func__);
		...
		value = regulator_enable(VCAM1_IO_1_8_V);
		if (value) {
			CAM_ERROR_PRINTK("%s:failed to enable VCAM1_IO_1_8_V\n", __func__);
			return -1;
		}
...
//		gpio_set_value(CAM_AF_EN,0); 
		...
		regulator_disable(VCAM1_IO_1_8_V);
